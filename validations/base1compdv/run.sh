# see the following script for the python scripted version
# of everything this shell file does
# time ./run_via_api.py

 SECONDS=0
 echo running clear glass...
time raytraverse -c scene/01_glz.cfg scene skyrun directskyrun evaluate pull
 echo running EC glass...
 time raytraverse -c scene/02_ecg.cfg scene skyrun directskyrun evaluate pull
 echo running rollershade...
 time raytraverse -c scene/03_shd.cfg scene skyrun directskyrun evaluate pull
 echo running trans...
 time raytraverse -c scene/04_trn.cfg scene skyrun directskyrun evaluate pull
 echo running glass reflection...
 time raytraverse -c scene/05_ngl.cfg scene skyrun directskyrun evaluate pull
 echo running metal reflection...
 time raytraverse -c scene/06_nmt.cfg scene skyrun directskyrun evaluate pull
 duration=$SECONDS
 echo $duration
